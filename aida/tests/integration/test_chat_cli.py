...
class ChatCLITestSuite(BaseTestSuite):
    ...
    async def test_single_tool_required(self) -> dict[str, Any]:
        ...
        results = {
            ...
            "categories": {"file_operations": 5, "thinking_analysis": 5, "system_execution": 5},
        }
    ...
    async def test_multi_tool_required(self) -> dict[str, Any]:
        ...
        results = {
            ...
            "complexity_levels": {"2_tools": 5, "3_tools": 5, "complex_scenarios": 5},
        }
    ...
    async def test_question_diversity(self) -> dict[str, Any]:
        ...
        question_types = {"how": 0, "what": 0, "create": 0, "write": 0, "explain": 0, "other": 0}

        all_questions = (
            self.no_tools_questions + self.single_tool_questions + self.multi_tool_questions
        )
    ...
    def get_test_questions(self, category: str = "all") -> list[str]:
        ...
        if category == "no_tools":
            ...
            return self.no_tools_questions + self.single_tool_questions + self.multi_tool_questions
