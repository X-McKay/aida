...
class ExecutionConfig:
    ...
    # Package management
    PACKAGE_MANAGERS = {
        "python": {"command": ["pip", "install"], "file": "requirements.txt"},
        "javascript": {"command": ["npm", "install"], "file": "package.json"},
        "node": {"command": ["npm", "install"], "file": "package.json"},
        "go": {"command": ["go", "get"], "file": "go.mod"},
        "rust": {"command": ["cargo", "add"], "file": "Cargo.toml"},
    }
