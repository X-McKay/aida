...
class ExecutionRequest(BaseModel):
    ...
    files: dict[str, str] | None = Field(None, description="Additional files needed")
    packages: list[str] | None = Field(None, description="Package dependencies")
    ...
    environment: ExecutionEnvironment = Field(
        ExecutionEnvironment.CONTAINER, description="Execution environment"
    )
...
class ExecutionResponse(BaseModel):
    ...
    memory_used: str | None = Field(None, description="Memory usage")
    files_created: list[str] | None = Field(None, description="Files created during execution")
