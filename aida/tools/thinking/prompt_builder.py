...
class ThinkingPromptBuilder:
    ...
    def _build_reasoning_prompt(self, request: ThinkingRequest) -> str:
        ...
        return template.format(perspective=request.perspective.value, depth=request.depth)
    ...
    def build_refinement_prompt(self, original_response: str, refinement_request: str) -> str:
