...
class ThinkingResponseParser:
    ...
    def _extract_summary(self, response: str) -> Optional[str]:
        ...
        summary_keywords = [
            "summary", "conclusion", "in conclusion",
            "recommendations", "next steps", "key takeaway"
        ]
