...
class ContextConfig:
    ...
    IMPORTANCE_KEYWORDS = [
        ...
        "priority", "urgent", "significant", "vital", "core", "fundamental"
    ]
    
    # Action Keywords
    ACTION_KEYWORDS = [
        "todo", "task", "action", "need to", "must", "should", "will",
        "plan to", "implement", "fix", "create", "update", "review"
    ]
    
    # Structural Markers
    STRUCTURAL_MARKERS = [
        "summary:", "conclusion:", "key points:", "overview:",
        "requirements:", "objectives:", "goals:", "results:"
    ]
