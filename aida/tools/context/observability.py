...
class ContextObservability:
    ...
    def _setup_observability(self):
        ...
        try:
            ...
            self.tracer = trace.get_tracer(
                self.config.get("service_name", "aida-context-tool")
            )
    ...
    def _setup_metrics(self):
        ...
        self.compression_ratio_histogram = self.meter.create_histogram(
            ...
            description="Compression ratios achieved",
            unit="ratio"
        )
    ...
    def record_operation(
        ...
        if compression_ratio and self.compression_ratio_histogram:
            self.compression_ratio_histogram.record(
                compression_ratio,
                {"operation": operation}
            )
